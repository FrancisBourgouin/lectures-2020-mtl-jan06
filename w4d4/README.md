# lhl-w4d4 - Responsive design + Sass
...
### Responsive is more than the window width

There is more to responsiveness than only the width of the browser, proper sizing, support for accessibility devices and others are important too. You can learn more about those practices with the A11Y project.
